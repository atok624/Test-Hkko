    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
      ...
      <div class="col-span-7">
        ...
        <div class="space-y-3">
          ...
          <p class="text-gray-700 leading-relaxed">
            HKKO Gold was conceived to circumvent the protracted and often convoluted processes associated with traditional gold transactions, which frequently involve multiple intermediaries. By leveraging cutting-edge technology, we have developed a sophisticated platform designed to streamline and expedite transactions, mitigating risks and ensuring a seamless experience for both buyers and sellers.
          </p>
        </div>
      </div>
